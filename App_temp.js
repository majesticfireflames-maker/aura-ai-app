  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (userName && (lowerInput.includes('what is my name') || 
        ...
        console.log(`âœ… ChatWidget answering name question: ${userName}`);
        responseText = `Your name is ${userName}! ðŸ˜Š`;
      } else {
...
const Login = ({ onLogin, settings = defaultSettings }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (result.success) {
      // âœ… Pass user profile to onLogin
...
class SupabaseManager {
  ...
  async initialize() {
    try {
      console.log('ðŸ” Initializing SupabaseManager...');
      const {
        data: { session },
        error,
      ...
      if (error) {
        console.error('âŒ Session error:', error.message);
        throw error;
      }
      ...
      console.error('âŒ Initialize error:', error.message);
      this.isConnected = false;
  ...
  async signUp(email, password, name) {
    try {
      ...
      if (result.success) {
        ...
        console.log('âœ… User signed up:', this.userId.substring(0, 8) + '...');
      ...
      console.error('âŒ Sign up error:', error.message);
      return { success: false, error: error.message };
    }
  }
  ...
  async signIn(email, password) {
    try {
      ...
      if (result.success) {
        this.userId = result.user.id;
        console.log('âœ… User signed in:', this.userId.substring(0, 8) + '...');
        const profileResult = await this.getUserProfile();
        if (profileResult.success) {
          this.userProfile = profileResult.profile;
        }
      ...
      console.error('âŒ Sign in error:', error.message);
      return { success: false, error: error.message };
    }
  }
  ...
  async signOut() {
    try {
      ...
      console.error('âŒ Sign out error:', error.message);
      return { success: false, error: error.message };
    }
  }
  ...
  async getUserProfile() {
    ...
    try {
      ...
      console.error('âŒ Get user profile error:', error.message);
      return { success: false, error: error.message };
    }
  }
...
async saveMeal(foodName, calories = 0) {  // ADD calories parameter
  ...
  try {
    ...
    if (result.success) {
      ...
      console.log(`âœ… Meal saved: ${foodName} (${calories} cal)`);
    }
    return result;
  } catch (error) {
    console.error('âŒ Save meal error:', error.message);
    return { success: false, error: error.message };
  }
}
...
async getMeals() {
  ...
  try {
    ...
    if (result.success && result.meals) {
      console.log('ðŸ“Š Meals from DB with calories:', 
        result.meals.map(m => ({
          food: m.food_name,
          calories: m.calories
        }))
    ...
    console.error('âŒ Get meals error:', error.message);
  ...
  async deleteMeal(mealId) {
    ...
    try {
      ...
      console.error('âŒ Delete meal error:', error.message);
      return { success: false, error: error.message };
    }
  }
  ...
  async clearAllMeals() {
    ...
    try {
      ...
      if (result.success) {
        this.dataCache.delete('meals');
        this.dataCache.delete('meals_today');
        console.log('âœ… All meals cleared');
      }
      return result;
    } catch (error) {
      console.error('âŒ Clear all meals error:', error.message);
      return { success: false, error: error.message };
    }
  }
...
async saveWorkout(workoutName, duration = 30, calories = 0) {
  ...
  try {
    ...
    if (result.success) {
      ...
      console.log(`âœ… Workout saved: ${workoutName} (${calories} cal)`);
    }
    return result;
  } catch (error) {
    console.error('âŒ Save workout error:', error.message);
    return { success: false, error: error.message };
  }
}
...
async getWorkouts() {
  ...
  try {
    ...
    console.error('âŒ Get workouts error:', error.message);
...
async deleteWorkout(workoutId) {
  ...
  try {
    ...
    console.error('âŒ Delete workout error:', error.message);
    return { success: false, error: error.message };
  }
}
...
async clearAllWorkouts() {
  ...
  try {
    ...
    if (result.success) {
      this.dataCache.delete('workouts');
      console.log('âœ… All workouts cleared');
    }
    return result;
  } catch (error) {
    console.error('âŒ Clear all workouts error:', error.message);
    return { success: false, error: error.message };
  }
}
  // FINANCE - SIMPLIFIED
  async saveTransaction(description, amount, type = 'expense') {
    ...
    try {
      ...
      if (result.success) {
        ...
        console.log('âœ… Transaction saved:', description);
      }
      return result;
    } catch (error) {
      console.error('âŒ Save transaction error:', error.message);
      return { success: false, error: error.message };
    }
  }
  ...
  async getTransactions() {
    ...
    try {
      ...
      console.error('âŒ Get transactions error:', error.message);
  ...
  async deleteTransaction(transactionId) {
    ...
    try {
      ...
      console.error('âŒ Delete transaction error:', error.message);
      return { success: false, error: error.message };
    }
  }
  ...
  async clearAllTransactions() {
    ...
    try {
      ...
      console.error('âŒ Clear all transactions error:', error.message);
      return { success: false, error: error.message };
    }
  }
  ...
  async saveTask(taskName) {
    ...
    try {
      ...
      if (result.success) {
        ...
        console.log('âœ… Task saved:', taskName);
      }
      return result;
    } catch (error) {
      console.error('âŒ Save task error:', error.message);
      return { success: false, error: error.message };
    }
  }
  ...
  async getTasks() {
    ...
    try {
      ...
      console.error('âŒ Get tasks error:', error.message);
  ...
  async updateTask(taskId, updates) {
    ...
    try {
      ...
      console.error('âŒ Update task error:', error.message);
      return { success: false, error: error.message };
    }
  }
  ...
  async deleteTask(taskId) {
    ...
    try {
      ...
      console.error('âŒ Delete task error:', error.message);
      return { success: false, error: error.message };
    }
  }
  ...
  async clearAllTasks() {
    ...
    try {
      ...
      console.error('âŒ Clear all tasks error:', error.message);
      return { success: false, error: error.message };
    }
  }
  ...
  async saveConversation(agentId, message, response, metadata = {}) {
    ...
    try {
      ...
      console.error('âŒ Save conversation error:', error.message);
      return { success: false, error: error.message };
    }
  }
  ...
  async saveSettings(settings) {
    ...
    try {
      ...
      console.error('âŒ Save settings error:', error.message);
      return { success: false, error: error.message };
    }
  }
  ...
  async getSettings() {
    ...
    try {
      ...
      console.error('âŒ Get settings error:', error.message);
  ...
  async clearAllData(type) {
    ...
    try {
      ...
      if (result) {
        console.log(`âœ… Cleared all ${type}`);
        return result;
      }

      return { success: false, error: 'Invalid data type' };
    } catch (error) {
      console.error(`âŒ Clear all ${type} error:`, error);
      return { success: false, error: error.message };
    }
  }
  ...
  async initializeDefaultData() {
    if (!this.userId) return;
    try {
      console.log('ðŸ“ Initializing default data for user');
      const welcomeTasks = [
        {
      ...
      console.error('âŒ Initialize default data error:', error);
    }
  }
...
class AgentService {
  constructor() {
    console.log('ðŸ¤– AgentService created');
    this.agents = {};
    this.userId = null;
    ...
    try {
      ...
      console.log('âœ… Connected to MessageBus and MemoryManager');
    } catch (error) {
      console.error(
        'âŒ Failed to connect to MessageBus/MemoryManager:',
        error.message
      );
    }
  ...
  initializeAgents() {
    console.log('ðŸ¤– Initializing agents with full integration...');
    ...
    try {
      ...
      Object.values(this.agents).forEach((agent) => {
        if (this.messageBus && agent.id) {
          ...
          console.log(`ðŸ”— Connected ${agent.id} to MessageBus`);
        }
      });

      console.log(
        `âœ… Created ${Object.keys(this.agents).length} fully integrated agents`
      );
    } catch (error) {
      console.error('âŒ Error initializing agents:', error.message);
      // Don't call createBasicAgents if it doesn't exist
      console.log('âš ï¸ Using fallback agent creation');
...
updateAllAgentsWithUserName(userName) {
  console.log(`ðŸ”„ Updating all agents with username: ${userName}`);
  ...
  Object.values(this.agents).forEach(agent => {
    try {
      if (agent) {
        ...
        // âœ… FORCE-ADD A WORKING getEnhancedResponse
        if (!agent.getEnhancedResponse || typeof agent.getEnhancedResponse !== 'function') {
          console.log(`âš ï¸ Adding PROPER getEnhancedResponse to ${agent.id}`);
          
          agent.getEnhancedResponse = async function(baseResponse) {
            console.log(`ðŸŽ¨ ${this.id} FORCE-METHOD for user: ${this.currentUserName}`);
            ...
            if (this.currentUserName && this.currentUserName !== 'Guest') {
              ...
              if (lastUserMessage.includes('what is my name') ||
                ...
                console.log(`ðŸ’¥ FORCE OVERRIDE: Name question detected`);
                return `Your name is ${this.currentUserName}! ðŸ˜Š`;
              }
              ...
              if (baseResponse.toLowerCase().includes("don't know") ||
                ...
                console.log(`ðŸ’¥ FORCE OVERRIDE: AI says doesn't know`);
                return `Actually, I know you're ${this.currentUserName}! ðŸ˜Š`;
              }
            }
        ...
        console.log(`âœ… ${agent.id} now knows user as: ${userName}`);
      }
    } catch (error) {
      console.log(`âš ï¸ Failed to update ${agent.id}:`, error.message);
    }
  });
}
...
setUserProfile(userId, userName, userProfile = null) {
  ...
  console.log(`ðŸ‘¤ AgentService: User profile set for ${userName} (${userId ? userId.substring(0, 8) + '...' : 'anonymous'})`);
  ...
  createFallbackAgents() {
    console.log('âš ï¸ Creating fallback agents...');
    ...
    this.agents = agents;
    console.log(`âœ… Created ${Object.keys(agents).length} fallback agents`);
  }

  setUserId(userId) {
    this.userId = userId;
    console.log(
      `ðŸ‘¤ AgentService: User ID set to ${
...
/*const ye = userMessage ? userMessage.toLowerCase() : ''; */
  console.log(`ðŸ“¨ [AgentService] Getting response from ${agentId} for: "${userMessage.substring(0, 30)}..."`);

    // âœ… NUCLEAR OPTION: INTERCEPT AND ANSWER DIRECTLY
  /*const lowerMessage = userMessage.toLowerCase();
  if (this.userName && (lowerMessage.includes('name') || lowerMessage.includes('who am i'))) {
    console.log(`ðŸ’¥ðŸ’¥ðŸ’¥ DIRECT INTERCEPTION FOR ${this.userName}`);
    return `Your name is ${this.userName}! ðŸ˜Š`;
  }*/
  ...
  if (this.userName && exactNameQuestions.some(q => lowerMessage.includes(q))) {
    console.log(`ðŸ’¥ðŸ’¥ðŸ’¥ DIRECT INTERCEPTION FOR NAME QUESTION`);
    return `Your name is ${this.userName}! ðŸ˜Š`;
  }
  ...
  if (!this.agents[agentId]) {
    console.error(`âŒ Agent ${agentId} not found!`);
    return this.getFallbackResponse(agentId, userMessage);
  }
  ...
  try {
    ...
    const message = {
      ...
      content: userMessage,
      userId: this.userId,
      userName: this.userName, // âœ… ADD THIS
      timestamp: new Date().toISOString()
    };
    
    console.log(`ðŸ¤– [${agentId}] Processing with cross-agent knowledge...`);
    console.log(`ðŸ‘¤ User context - ID: ${this.userId ? this.userId.substring(0, 8) + '...' : 'none'}, Name: ${this.userName || 'unknown'}`);
    ...
    try {
      ...
      if (aiResponse && aiResponse.length > 20) {
        ...
        console.log(`âœ… [${agentId}] AI service responded`);
      }
    } catch (aiError) {
      console.log(`âš ï¸ [${agentId}] AI service failed:`, aiError.message);
    }
    ...
    // âœ… CRITICAL FIX: ALWAYS call getEnhancedResponse on the AGENT
    const agent = this.agents[agentId];
    if (agent && typeof agent.getEnhancedResponse === 'function') {
      console.log(`ðŸŽ¨ [${agentId}] Applying personalization for user: ${agent.currentUserName || 'unknown'}`);
      response = await agent.getEnhancedResponse(response);
    } else {
      console.log(`âš ï¸ [${agentId}] No getEnhancedResponse method available`);
    }
    
    // Share knowledge with other agents
    await this.shareKnowledgeToOtherAgents(agentId, userMessage, response);
    
    console.log(`ðŸŽ¯ [${agentId}] Returning ${response.length} chars`);
    return response;
    
  } catch (error) {
    console.error(`âŒ [${agentId}] Error getting response:`, error.message);
    return this.getFallbackResponse(agentId, userMessage);
  }
}
  async shareKnowledgeToOtherAgents(sourceAgentId, userMessage, agentResponse) {
    ...
    try {
      ...
      if (uniqueTargets.length > 0) {
        console.log(
          `ðŸ“¢ Sharing knowledge from ${sourceAgentId} to: ${uniqueTargets.join(
            ', '
          )}`
        );
      ...
      console.log(
        `âš ï¸ Knowledge sharing error for ${sourceAgentId}:`,
        error.message
      );
    }
  }
...
try {
  console.log('ðŸš€ Creating global instances...');
  supabaseManager = new SupabaseManager();
  agentService = new AgentService();
  console.log('âœ… Global instances created successfully');
} catch (error) {
  console.error('âŒ Failed to create global instances:', error.message);
...
class BaseAgent {
  constructor(id, role = 'Assistant', aiService = null, agentService = null) {
    ...
    this.currentUserName = null; // âœ… Added: Store username
    this.userProfile = null; // âœ… Added: Store full profile
    this.conversationHistory = [];
      this.conversationHistory = []; // âœ… Make sure this is here
  

    console.log(`ðŸ¤– ${this.id} agent created with full memory integration`);
  }
...
async getEnhancedResponse(baseResponse) {
  console.log(`ðŸ’£ NUCLEAR FIX VERSION 2.0`);
  
  if (this.currentUserName && this.currentUserName !== 'Guest') {
    console.log(`âœ… Username: ${this.currentUserName}`);
    ...
    if (this.conversationHistory && this.conversationHistory.length > 0) {
      ...
      if (lastMsg && lastMsg.content) {
        ...
        if (userMsg.includes('what is my name') ||
          ...
          console.log(`ðŸ’¥ NUCLEAR: User asked DIRECTLY about name`);
          return `Your name is ${this.currentUserName}! ðŸ˜Š`;
        }
      }
    }
    ...
    if (aiDeniesKnowledge) {
      console.log(`ðŸ’¥ NUCLEAR: AI denies knowledge`);
  ...
  // âœ… NEW: Check if we should greet with name
  shouldGreetWithName() {
  ...
  // âœ… NEW: Get personalized greeting
  ...
  // âœ… UPDATED: Set user with optional username and profile
  ...
  // âœ… NEW: Simple method to set just the username
  setUserName(userName) {
    this.currentUserName = userName;
    console.log(`${this.id} now knows user as: ${userName}`);
  }

  // âœ… Keep all existing methods exactly as they were
  async getCrossAgentKnowledge() {
    ...
    try {
      ...
      let context = '\n\nðŸ” **What I know from other agents:**\n';
      knowledge.forEach((item, index) => {
        if (index < 3 && item.agent && item.message) {
          ...
          context += `â€¢ From ${agentName} (${timeAgo}): ${item.message.substring(
            0,
            60
          )}...\n`;
        }
      ...
      console.log(`âš ï¸ ${this.id} cross-agent knowledge error:`, error.message);
      return '';
    }
  }
  ...
  async saveToMemory(message, response) {
    ...
    try {
      ...
      console.log(`ðŸ’¾ ${this.id} saved to memory`);
      return true;
    } catch (error) {
      console.log(`âš ï¸ ${this.id} memory save error:`, error.message);
      return false;
    }
  }
...
class NutritionAgentClass extends BaseAgent {
  ...
  async receiveMessage(message) {
    console.log(
      `ðŸŽ Nutrition processing: "${
        message.content?.substring(0, 50) || 'no content'
      }..."`
    );

      // âœ… ADD THESE LINES at the START:
    ...
    try {
      ...
      if (this.aiService) {
        try {
          ...
          console.log('âš ï¸ Nutrition AI failed:', aiError.message);
        }
      }
      ...
      if (
        ...
        console.log(`ðŸŽ Nutrition: Attempting to save meal "${foodName}"`);

        try {
          const result = await supabaseManager.saveMeal(foodName);

          if (result.success) {
            console.log(`âœ… Nutrition: Successfully saved meal "${foodName}"`);
            response = `${response}\n\nâœ… **Logged meal:** ${foodName}`;
          } else {
            console.error(`âŒ Nutrition: Failed to save meal: ${result.error}`);
            response = `${response}\n\nâš ï¸ Couldn't save meal to database.`;
          }
        } catch (saveError) {
          console.error('âŒ Meal save error:', saveError.message);
          response = `${response}\n\nâš ï¸ Error saving meal.`;
        }
      }
      ...
      console.log('âŒ Nutrition error:', error.message);
      return {
        reply:
    ...
    try {
      ...
      if (this.aiService) {
        try {
          ...
          console.log('âš ï¸ Fitness AI failed:', aiError.message);
        }
      }
      ...
      if (
        ...
        console.log(
          `ðŸ’ª Fitness: Attempting to save workout "${workoutInfo.name}"`
        );
        ...
        try {
          ...
          if (result.success) {
            console.log(
              `âœ… Fitness: Successfully saved workout "${workoutInfo.name}"`
            );
            response = `${response}\n\nâœ… **Logged workout:** ${workoutInfo.name} (${workoutInfo.duration} min)`;
          } else {
            console.error(
              `âŒ Fitness: Failed to save workout: ${result.error}`
            );
            response = `${response}\n\nâš ï¸ Couldn't save workout to database.`;
          }
        } catch (saveError) {
          console.error('âŒ Workout save error:', saveError.message);
          response = `${response}\n\nâš ï¸ Error saving workout.`;
        }
      }
      ...
      console.log('âŒ Fitness error:', error.message);
      return {
        reply:
    ...
    try {
      ...
      if (this.aiService) {
        try {
          ...
          console.log('âš ï¸ Finance AI failed:', aiError.message);
        }
      }
      ...
      if (
        ...
        console.log(
          `ðŸ’° Finance: Attempting to save transaction "${transaction.description}"`
        );
        ...
        try {
          ...
          if (result.success) {
            console.log(
              `âœ… Finance: Successfully saved transaction "${transaction.description}"`
            );
            response = `${response}\n\nâœ… **Logged ${
              transaction.type
            ...
            console.error(
              `âŒ Finance: Failed to save transaction: ${result.error}`
            );
            response = `${response}\n\nâš ï¸ Couldn't save transaction to database.`;
          }
        } catch (saveError) {
          console.error('âŒ Transaction save error:', saveError.message);
          response = `${response}\n\nâš ï¸ Error saving transaction.`;
        }
      }
      ...
      console.log('âŒ Finance error:', error.message);
      return {
        reply:
  ...
  if (message.userId) {
    ...
    try {
      ...
      if (
        ...
        console.log(
          `ðŸ§  Recognizing food preference question for mental wellness`
        );
        ...
        if (this.aiService) {
          try {
            ...
            console.log('âš ï¸ Mental AI failed:', aiError.message);
          }
        }
      }
      ...
      console.log('âŒ Mental error:', error.message);
      return {
        reply:
    ...
    try {
      ...
      if (this.aiService) {
        try {
          ...
          console.log('âš ï¸ Planner AI failed:', aiError.message);
        }
      }
      ...
      if (
        ...
        console.log(`ðŸ“ Planner: Attempting to save task "${taskName}"`);
        ...
        try {
          ...
          if (result.success) {
            console.log(`âœ… Planner: Successfully saved task "${taskName}"`);
            response = `${response}\n\nâœ… **Added task:** ${taskName}`;
          } else {
            console.error(`âŒ Planner: Failed to save task: ${result.error}`);
            response = `${response}\n\nâš ï¸ Couldn't save task to database.`;
          }
        } catch (saveError) {
          console.error('âŒ Task save error:', saveError.message);
          response = `${response}\n\nâš ï¸ Error saving task.`;
        }
      }
      ...
      console.log('âŒ Planner error:', error.message);
      return {
        reply:
    ...
    try {
      ...
      if (this.aiService) {
        try {
          ...
          console.log('âš ï¸ Creative AI failed:', aiError.message);
        }
      }
      ...
      console.log('âŒ Creative error:', error.message);
      return {
        reply:
...
async receiveMessage(message) {
  ...
  try {
    ...
    console.log('âŒ General error:', error.message);
...
const NutritionAgentPage = ({ settings }) => {
  ...
  useEffect(() => {
    console.log('ðŸ½ï¸ Nutrition Page Mounted');
    loadMeals();
  }, []);
...
const loadMeals = async () => {
  try {
    ...
    if (result.success) {
      console.log(`âœ… Loaded ${result.meals?.length || 0} meals`);
      ...
      console.error('âŒ Failed to load meals:', result.error);
      Alert.alert('Error', result.error || 'Failed to load meals');
    }
  } catch (error) {
    console.error('âŒ Error loading meals:', error);
...
const handleAddMeal = async () => {
  ...
  try {
    ...
    console.log('âž• Adding meal with calories:', {
      name: newMealName,
      calories: calories,
    ...
    if (result.success) {
      console.log('âœ… Meal saved successfully with calories:', calories);
      setNewMealName('');
      setNewMealCalories('');
      ...
      console.error('âŒ Failed to add meal:', result.error);
      Alert.alert('Error', result.error || 'Failed to add meal');
    }
  } catch (error) {
    console.error('âŒ Add meal error:', error);
  ...
  const handleDeleteMeal = async (mealId) => {
    try {
      ...
      if (result.success) {
        ...
        console.error('âŒ Failed to delete meal:', result.error);
        Alert.alert('Error', result.error || 'Failed to delete meal');
      }
    } catch (error) {
      console.error('âŒ Delete meal error:', error);
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              console.log('ðŸ—‘ï¸ Clearing all meals...');
              ...
              if (result.success) {
                ...
                console.error('âŒ Failed to clear meals:', result.error);
                Alert.alert('Error', result.error || 'Failed to clear meals');
              }
            } catch (error) {
              console.error('âŒ Clear meals error:', error);
  ...
  const handleChatResponse = async (input) => {
    console.log('ðŸ’¬ Nutrition chat input:', input);
...
<View style={stylesNutrition.header}>
  ...
  {meals.length} meals â€¢ {totalCalories} calories
</Text>
  </View>
  <TouchableOpacity
...
const FitnessAgentPage = ({ settings }) => {
  ...
  useEffect(() => {
    console.log('ðŸ’ª NUCLEAR FITNESS PAGE MOUNTED');
    loadWorkoutsNuclear();
  }, []);
  ...
  const saveWorkoutLocal = async (workout) => {
    try {
      ...
      console.log('âœ… Saved to local storage:', workout);
      return true;
    } catch (error) {
      console.error('âŒ Local storage error:', error);
      return false;
    }
  };
  ...
  const loadWorkoutsLocal = async () => {
    try {
      ...
      console.log('ðŸ“‹ Loaded from local storage:', workouts.length, 'workouts');
      return workouts;
    } catch (error) {
      console.error('âŒ Load local error:', error);
      return [];
    }
  };
  ...
  const saveWorkoutSupabase = async (workoutData) => {
    if (!supabaseManager.userId) {
      console.log('âŒ No user ID for Supabase');
      return false;
    }

    try {
      console.log('ðŸ’¾ Attempting Supabase save:', workoutData);
      ...
      console.error('âŒ Supabase save error:', error);
      return false;
    }
  };
  ...
  const loadWorkoutsSupabase = async () => {
    ...
    try {
      console.log('ðŸ“‹ Attempting Supabase load');
      ...
      if (error) {
        console.error('âŒ Supabase load error:', error);
        return [];
      }
      
      console.log('âœ… Supabase load successful:', data?.length || 0, 'workouts');
      return data || [];
    } catch (error) {
      console.error('âŒ Supabase load error:', error);
      return [];
  ...
  const loadWorkoutsNuclear = async () => {
    console.log('ðŸ“‹ NUCLEAR LOAD STARTED');
    setIsLoading(true);
    ...
    try {
      ...
      if (!workoutsData || workoutsData.length === 0) {
        console.log('âš ï¸ Supabase failed, trying local storage');
      ...
      console.log('âœ… FINAL WORKOUTS:', formatted.map(f => ({
        title: f.title,
        calories: f.calories,
        duration: f.duration
      })));
      ...
      console.error('âŒ Nuclear load error:', error);
    } finally {
      setIsLoading(false);
      setRefreshing(false);
    }
  ...
  const estimateWorkoutCaloriesNuclear = (workoutName, duration) => {
    console.log(`ðŸ”® Estimating for: ${workoutName}, ${duration}min`);
    ...
    console.log(`ðŸ”® Estimated: ${estimated} calories (${caloriesPerMinute}/min Ã— ${minutes}min)`);
  ...
  const handleAddWorkoutNuclear = async () => {
    console.log('âž• NUCLEAR ADD STARTED');
    ...
    console.log('âž• WORKOUT TO SAVE:', workoutObject);
    ...
    if (localSuccess || supabaseSuccess) {
      ...
      Alert.alert('Success', `âœ… Workout logged! (${calories} calories burned)`);
  ...
  const handleChatResponse = async (input) => {
    console.log('ðŸ’¬ Fitness chat input:', input);
    ...
    try {
      ...
      console.log('âœ… Fitness chat response:', response ? response.substring(0, 100) : 'No response');
      return response;
    } catch (error) {
      console.error('âŒ Chat error:', error);
  ...
  const renderWorkoutItem = ({ item }) => (
    <View
      ...
      <View style={stylesFitness.workoutDetails}>
        ...
        <Text style={[stylesFitness.workoutDot, { color: colors.textTertiary }]}>â€¢</Text>
        ...
        <View style={stylesFitness.header}>
          <View>
            ...
            <Text style={[stylesFitness.subtitle, { color: colors.textSecondary }]}>
              {workouts.length} workouts â€¢ {totalCalories} cal â€¢ {totalMinutes} min
            </Text>
          </View>
          <TouchableOpacity
          ...
          <View style={[stylesFitness.addWorkoutCard, { backgroundColor: colors.bgCard, borderColor: colors.borderPrimary }]}>
            ...
            {!newWorkoutCalories && newWorkout.name && (
              <Text style={[stylesFitness.estimateText, { color: '#A855F7' }]}>
                ðŸ”® Estimated: {estimateWorkoutCaloriesNuclear(newWorkout.name, newWorkout.duration)} calories
              </Text>
            )}
...
const FinanceAgentPage = ({ settings }) => {
  ...
  // Chat response handler - FIXED: Using agentService directly
  const handleChatResponse = async (input) => {
    console.log('ðŸ’¬ Finance chat input:', input);
...
const FinalPlannerPage = ({ settings }) => {
  ...
  useEffect(() => {
    console.log('ðŸ“Š Tasks state updated:', {
      total: tasks.length,
  ...
  const loadTasks = async () => {
    ...
    try {
      ...
      if (result.success && result.tasks) {
        console.log('ðŸ“‹ Loaded tasks:', result.tasks.length);
        ...
        const processedTasks = result.tasks.map((task) => {
          ...
          console.log('ðŸ“„ Processing task:', task.title);
          ...
          if (task.metadata) {
            try {
              ...
              console.log('âŒ Metadata parse error:', e.message);
          ...
          console.log(
            `âœ… Final: priority="${priority}", category="${category}"`
          );
        ...
        console.log(
          'ðŸ“Š Loaded tasks (excluding completed):',
  ...
  const refreshTasks = async () => {
    console.log('ðŸ”„ Refreshing tasks (hiding completed)...');
    await loadTasks();
  };
  ...
  const handleSaveTask = async () => {
    ...
    try {
      ...
      console.log('ðŸ“¦ Saving metadata:', metadata);

      if (editingTask) {
        // Update task
        console.log(`âœï¸ Updating task ${editingTask.id}`);
        ...
        if (result.success) {
          ...
          console.error('âŒ Update failed:', result.error);
        ...
        if (result.success) {
          ...
          console.log('ðŸ“ New task object:', newTaskObj);
          setTasks((prev) => [newTaskObj, ...prev]);
        } else {
          console.error('âŒ Create failed:', result.error);
  ...
  const handleToggleComplete = async (taskId) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        console.error('âŒ Toggle failed:', result.error);
  ...
  const handleChatResponse = async (input) => {
    console.log('ðŸ’¬ Planner chat input:', input);
...
const GeneralChatAgentPage = ({ settings }) => {
  ...
  const handleChatResponse = async (input) => {
    try {
      ...
      console.error('âŒ Chat response error:', error);
...
const MentalWellnessAgentPage = ({ settings }) => {
  ...
  const moodOptions = [
    { emoji: 'ðŸ˜Š', label: 'Happy', value: 'happy', color: '#10B981' },
    { emoji: 'ðŸ˜', label: 'Neutral', value: 'neutral', color: '#6B7280' },
    { emoji: 'ðŸ˜”', label: 'Sad', value: 'sad', color: '#3B82F6' },
    { emoji: 'ðŸ˜°', label: 'Anxious', value: 'anxious', color: '#F59E0B' },
    { emoji: 'ðŸ˜´', label: 'Tired', value: 'tired', color: '#8B5CF6' },
  ];

  // ENHANCED AFFIRMATIONS WITH EMOJIS
  const affirmations = [
    { text: 'I am enough just as I am', emoji: 'âœ¨' },
    { text: 'My feelings are valid and important', emoji: 'â¤ï¸' },
    { text: 'I am stronger than my challenges', emoji: 'ðŸ’ª' },
    { text: 'I choose peace over perfection', emoji: 'â˜®ï¸' },
    { text: 'Today is a fresh start', emoji: 'ðŸŒ…' },
  ];
  ...
  const wellnessTips = [
    { text: 'Drink water when feeling anxious', emoji: 'ðŸ’§' },
    { text: '5-minute walk can reset your mood', emoji: 'ðŸš¶' },
    { text: 'Consistent sleep improves mental health', emoji: 'ðŸŒ™' },
    { text: 'Journaling reduces stress by 30%', emoji: 'ðŸ“' },
    { text: 'Nature exposure boosts serotonin', emoji: 'ðŸŒ¿' },
  ];
  ...
  // Simple chat handler
  const handleChatResponse = async (input) => {
    console.log('ðŸ§  Mental chat input:', input);
...
const SettingsPage = ({ settings, onUpdateSettings, onLogout }) => {
  ...
  const handleSettingChange = async (key, value) => {
    ...
    try {
      ...
      console.log('âŒ Error saving settings:', error);
    }
...
export default function App() {
  ...
  const initializeApp = async () => {
    try {
      console.log('ðŸš€ Initializing Aura AI app...');
      setIsLoading(true);
      ...
      if (result.success && result.user) {
        ...
        console.log('â„¹ï¸ No user session, showing login');
      }
    } catch (error) {
    ...
    if (supabaseManager.userId) {
      ...
      if (userProfile || supabaseManager.userProfile) {
        ...
        if (userName) {
          ...
          console.log(`ðŸ‘¤ Username "${userName}" passed to agents`);
        }
      }
    }
  ...
  const handleNavigation = (section) => {
    console.log(`ðŸ“ Navigation: ${section}`);
